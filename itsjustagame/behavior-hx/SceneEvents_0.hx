...
class SceneEvents_0 extends SceneScript
{
	...
	override public function init()
	{
		...
		addWhenUpdatedListener(null, function(elapsedTime:Float, list:Array<Dynamic>):Void
		{
			if(wrapper.enabled)
			{
				if((Engine.engine.getGameAttribute("death 2") == 1))
				{
					switchScene(GameModel.get().scenes.get(1).getID(), createFadeOut(3, Utils.getColorRGB(0,0,0)), createFadeIn(2, Utils.getColorRGB(0,0,0)));
				}
